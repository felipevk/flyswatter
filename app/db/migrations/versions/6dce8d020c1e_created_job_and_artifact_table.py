...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('QUEUED', 'RUNNING', 'SUCCEEDED', 'FAILED', name='job_state_enum'), nullable=False),
    ...
    sa.Column('result_kind', sa.Enum('ARTIFACT', 'ENTITY', name='ck_result_kind', native_enum=False), nullable=True),
